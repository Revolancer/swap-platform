...
import { ProjectStatusForAdmin } from '@/components/project-hub/project-status-for-admin';
    ...
    const loadProject = async () => {
      if (id != null) {
        if (Array.isArray(id)) {
          ...
          await axiosPrivate
            .get(`/admin/users/${uid}/projects/${id}`)
            .then((response) => {
        ...
        <FullWidth>
          ...
          <Card>
            ...
            {hasLoaded && loadedData && (
              <Flex column>
                <ProjectStatusForAdmin project={loadedData} />
                <Flex
                  css={{
